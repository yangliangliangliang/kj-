<template>
	<view @click="toggle" class="evan-switch" 
		...
		:style="{width:50+'px',height:22+'px',borderRadius:size+'px',backgroundColor:currentValue===activeValue?activeColor:inactiveColor}">
		<view class="evan-switch__circle" :style="{width:42+'rpx',height:42+'rpx',transform:currentValue===activeValue?`translateX(${size}px)`:`translateX(0)`}"></view>
	</view>
</template>
